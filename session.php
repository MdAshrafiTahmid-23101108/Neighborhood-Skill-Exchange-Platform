...
// Get all accepted barters/sessions for this user
$sql = "
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // Fetch the skill that was requested in this barter
        // The user who sent the request is User_1, the skill they requested is in user_skill
        $sql_skill = "
        ...
        if ($skill_result && mysqli_num_rows($skill_result) > 0) {
            // Get the first skill (the requested skill)
